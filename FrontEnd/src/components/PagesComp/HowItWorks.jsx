              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center text-center w-full max-w-xs">
                    ...
                    {/* Step Circle */}
                    <div className={`relative flex-shrink-0 w-16 h-16 rounded-full flex items-center justify-center border-4 transition-all duration-300 ${
                      isCompleted 
                    ...
                    <div className={`mt-4 transition-all duration-300 ${
                      ...
                      <h3 className={`text-lg font-semibold mb-2 ${
                        isActive || isCompleted ? 'text-[#222B3A]' : 'text-gray-500'
                      }`}>
                        {step.title}
                      </h3>
                  ...
                  {index < steps.length - 1 && (
                    <div className="lg:hidden absolute top-8 left-1/2 transform translate-x-16 h-8 w-0.5 bg-gray-200">
                      <div 
                        className={`w-full h-full transition-all duration-500 ${
                          isCompleted ? 'bg-[#F36B4A]' : 'bg-gray-200'
                        }`}
